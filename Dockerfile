...
ARG CONNECT_USER
USER root
RUN wget https://cdn.azul.com/zulu/bin/zulu17.34.19-ca-jdk17.0.3-linux.x86_64.rpm && yum install -y zulu17.34.19-ca-jdk17.0.3-linux.x86_64.rpm && alternatives --set java /usr/lib/jvm/zulu-17/bin/java
